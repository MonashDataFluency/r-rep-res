...
subtitle: ""
author: "Kirill Tsyganov & Adele Barugahare"
...
style_mono_accent_inverse(base_color = "#00a3cc")
```


## Workshop Housekeeping

Please keep yourself unmuted and video off

Ask questions on the Slack chat (or unmute yourself!)

Today, we'll focus on R Markdown, and a lil on Git

Tomorrow: Git + GitHub + R Markdown

Data Fluency has a git workshop - strongly recommend if you want to learn more
...
The workshop Slack channel will be archived after the workshop, however stay involved by asking questions on general and coding-help channels on the Data Fluency Slack channels
...
Use the rmarkdown package to build various document types including PDF, HTML and DOCX
...
R Markdown = create documents that can contain both code and formatted text

Git + Git Hub = how to version control your analysis & share it
...
* Write your analysis with an R Markdown document
* Record software versions
* Track changes to the document with git
* Collaborate with others using git + github
* Share with github
]

R + RStudio + R Markdown is an ideal environment to work in but can also support other programming languages such as Python, Bash, SQL, etc.
...
R Markdown is a package for publishing documents in R

An Rmarkdown file is a plain text file that allows you to embed R code chunks & text & images. 

The file can both save and execute code as well as generate high quality reports.
...
## Avoids `r anicon::nia("This", animate="bounce", speed = "slow")`
