...
In the first part of the book we will discuss origins and the ecosystem of Rmarkdown language. We will explore in details the three core parts of an Rmarkdown document and different output document types. This section follows hands-on style of teaching - code along !

## Introduction

Let's begin with opening a plain text file by either executing the following command
